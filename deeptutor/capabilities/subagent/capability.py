...
class SubagentCapability(KnowledgeCapability):
    ...
    def augment_kwargs(
        ...
        # Persistent continuity is loaded by the shared execution guard. Keeping
        # the read beside consult + remember ensures a concurrent sidebar/tool
        # caller observes the native session id returned by its predecessor.
